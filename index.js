...
beepSound.play();
die1.classList.replace(diceClasses[previousRoll[0] - 1], diceClasses[diceValue[0] - 1]);
die2.classList.replace(diceClasses[previousRoll[1] - 1], diceClasses[diceValue[1] - 1]);
}
